...
const translations: Record<string, Translations> = {
  en: {
    ...
    setup: {
      ...
      herdrNotFound: "warning: herdr was not found. Install it first:",
      ...
      herdrConfigMissingResume: "warning: Existing herdr config.toml has no resume_agents_on_restore.",
      herdrConfigResumeHint: "   Add [session] resume_agents_on_restore = true",
      herdrServiceFile: "herdr service file: {{path}}",
      herdrAlreadyRunning: "warning: herdr server is already running outside launchd. Switch manually:",
      herdrSystemdOutside: "warning: herdr server is running outside systemd. Switch manually:",
      herdrStartedLaunchd: "Started herdr server with launchd",
      herdrEnabledSystemd: "Enabled herdr service with systemd",
      herdrStartFailed: "warning: Failed to start herdr service",
      herdrIntegrationConfigured: "Configured herdr {{agent}} integration",
      herdrIntegrationFailed: "warning: Failed to install herdr {{agent}} integration:",
      ...
      serviceStartFailed: "warning: Failed to start service",
      ...
      serviceEnableFailed: "warning: Failed to enable service",
  ...
  ja: {
    ...
    setup: {
      ...
      serviceStartFailed: "警告: サービスの起動に失敗しました",
      ...
      serviceEnableFailed: "警告: サービスの有効化に失敗しました",
