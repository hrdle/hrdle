...
import { resolveSessionTarget } from '../glasses';

/**
 * Session resolution for `cchub glasses` (#504): cwd unique match → /proc
 * ancestor ↔ pane foreground pid (worktree defense) → --session required.
 */
